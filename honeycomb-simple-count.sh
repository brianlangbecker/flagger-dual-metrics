...
# Simple Honeycomb count query - no filters needed
API_KEY="CbUVTd7D7rrdzvcV1FOu8B"
DATASET="cosmic-canary-service"
BASE_URL="https://api.honeycomb.io"

echo "🚀 Creating simple COUNT query (no filters)..."
echo "Dataset: $DATASET"
echo "URL: ${BASE_URL}/1/queries/${DATASET}"
echo ""

# Simple query - just count everything in the dataset
